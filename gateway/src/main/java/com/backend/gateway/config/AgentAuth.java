...
@RefreshScope
@Component("AgentAuth")
public class AgentAuth extends AuthFilter<BaseAuthConfig> {

    @Value("${secure.header.agent.secret:default-secret}")
    private String secret;

    @Value("${secure.agent.whitelist-paths:/health}")
    private String whitelistPaths;

    @Value("${secure.agent.authorized-methods:}")
    private String authorizedMethods;

    public AgentAuth(@Qualifier("blockingTaskScheduler") Scheduler scheduler, CacheManager cacheManager) {
