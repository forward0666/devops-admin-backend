...
12|@Slf4j
13|@RefreshScope
14|@Component("cloudflare")
15|public class CloudflareAuth extends AuthFilter<BaseAuthConfig> {
16|
17|    @Value("${secure.cloudflare.whitelist-paths:}")
18|    private String whitelistPaths;
19|
20|    public CloudflareAuth() {
