...
public class ManageAuth extends AuthFilter<BaseAuthConfig> {

    @Value("${secure.header.manage.secret:default-secret}")
    private String secret;

    @Value("${secure.manage.whitelist-paths:}")
    private String whitelistPaths;

    @Value("${secure.manage.authorized-methods:}")
    private String authorizedMethods;

    public ManageAuth(@Qualifier("blockingTaskScheduler") Scheduler scheduler, CacheManager cacheManager) {
