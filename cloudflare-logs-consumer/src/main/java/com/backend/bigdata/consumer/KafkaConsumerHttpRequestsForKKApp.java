...
public class KafkaConsumerHttpRequestsForKKApp {
    ...
    public KafkaConsumerHttpRequestsForKKApp(
        ...
        this.batchConsumer = new CloudflareLogsBatchConsumer(
                executorService,
                cloudflareLogsMapper::batchInsertCloudflareHttpLogsForKKApp,
                topic
        );
    }

    @KafkaListener(
            topics = "${cloudflare.topic:cloudflare_logs_http_requests_kk_app}",
