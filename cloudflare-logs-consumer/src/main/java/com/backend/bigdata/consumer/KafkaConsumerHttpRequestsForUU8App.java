...
public class KafkaConsumerHttpRequestsForUU8App {
    ...
    public KafkaConsumerHttpRequestsForUU8App(
        ...
        this.batchConsumer = new CloudflareLogsBatchConsumer(
                executorService,
                cloudflareLogsMapper::batchInsertCloudflareHttpLogsForUU8App,
                topic
        );
    }

    @KafkaListener(
            topics = "${cloudflare.topic:cloudflare_logs_http_requests_uu8_app}",
